...
Invariant1 == \A p \in Proc, r \in Rounds, o \in Proc: (p \notin faulty /\ dag[p][r][o].ratifiedVertex # "Nil") =>  
                     \E A \in SUBSET(VertexSet) : /\ Cardinality({q \in Proc: (\E u \in A: u.source = q)}) = n-f 
...
Invariant4 == \A p \in Proc, u \in VertexSet: p \notin faulty /\ u.source \notin faulty /\ u \in dag[p][u.round][u.source].vertices 
                                    => u \in dag[u.source][u.round][u.source].vertices
...
\* Last modified Sun Apr 21 19:08:17 CEST 2024 by Pranav
\* Created Fri Apr 19 11:30:31 CEST 2024 by Pranav
